...
- Mesh-VPN logs (`/var/log/mesh-vpn/log.txt`)
...
✓ API endpoints tested:
  ...
  - `/api/mesh-vpn/exit-nodes` - Lists Mesh-VPN exit nodes
  - `/api/mesh-vpn/set-exit` - Sets Mesh-VPN exit node
✓ Dashboard HTML renders correctly (51KB, 1240 lines)
✓ External IP detection working (showing: 67.211.240.4)
✓ Mesh-VPN status detected (active: true, IP: 100.120.35.91)
...
- `GET /api/mesh-vpn/exit-nodes` - Mesh-VPN exit nodes
...
- `POST /api/mesh-vpn/set-exit` - Set Mesh-VPN exit node
